...
async function run() {
    console.log("🍷 Winery Hunter Bot Initializing (Gemini Edition)...");
    ...
    console.log(`🎯 Targeting Region: ${regionDoc.name} (${regionDoc.country})`);
    ...
    try {
        ...
        for (const candidate of candidates) {
            ...
            if (exists) {
                console.log(`⚠️ Skipping ${candidate.name} (Slug collision)`);
                continue;
            }

            console.log(`📝 Drafting: ${candidate.name}...`);
        ...
        console.log("\n✅ Mission Complete. Check Admin Panel for Drafts.");
